...
accountRouter.get("/", authorize("Normal", "Admin"), (req: Request, res: Response) => {
    res.render("acccount.ejs", { url : "/account", cart_item_count : req.signedCookies.cart_item_count,
